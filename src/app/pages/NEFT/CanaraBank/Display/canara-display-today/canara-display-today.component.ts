...
@Component({
  selector: 'app-canara-display-today',
  templateUrl: './canara-display-today.component.html',
  styleUrls: ['./canara-display-today.component.css'],
  providers: [ApiCallsService]
})
export class CanaraDisplayTodayComponent implements OnInit {
  trucknopart: any;
  uniqueTrucks = [];
  public date;
  ...
  find() {
    this.apiCallservice.handleData_New(this.dbName, 'CanaraBankNEFT/getCanBankNEFTDetailsToday', 1, 0)
