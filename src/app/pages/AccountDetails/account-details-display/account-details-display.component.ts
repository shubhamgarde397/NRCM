...
export class AccountDetailsDisplayComponent implements OnInit {
  ...
  public options = [
    ...
    {'viewValue':'Pan','value':'2','disabled':true},
    {'viewValue':'Contact','value':'3','disabled':true},
    {'viewValue':'Account','value':'4','disabled':false},
    {'viewValue':'Transport Name','value':'5','disabled':false},
    {'viewValue':'Vehicle Type','value':'6','disabled':true},
    {'viewValue':'Weight','value':'7','disabled':true},
    {'viewValue':'Dimensions','value':'8','disabled':false},
    {'viewValue':'Update Account Details','value':'9','disabled':true},
    {'viewValue':'Truck Format','value':'10','disabled':true}
  ]
  public displayType;
  public buttonOption;
  public buttonValue;
...
switch (this.buttonOption) {
  ...
  getInformationDataCC() {
    ...
    this.apiCallservice.handleData_New_python('commoninformation', 1, tempObj, 0,undefined,'nrcm')
      .subscribe((res: any) => {
...
// getpan infor from other reports, i want same ui
  ...
  getData(option){
    ...
    tempObj['tablename']='';
    tempObj['option']=1;
    this.apiCallservice.handleData_New_python('commoninformation', 1, tempObj, 1,undefined,'nrcm')
    .subscribe((res: any) => {
